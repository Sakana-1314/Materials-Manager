import{m as W,a7 as t,p as o,n as C,q as v,ab as F,aI as I,aJ as K,d as q,l as D,t as J,v as z,O as N,x as A,y as f,aK as x}from"./index-DwihmnM-.js";const G={thPaddingSmall:"6px",thPaddingMedium:"12px",thPaddingLarge:"12px",tdPaddingSmall:"6px",tdPaddingMedium:"12px",tdPaddingLarge:"12px"};function Q(e){const{dividerColor:r,cardColor:a,modalColor:s,popoverColor:l,tableHeaderColor:c,tableColorStriped:b,textColor1:p,textColor2:g,borderRadius:n,fontWeightStrong:d,lineHeight:i,fontSizeSmall:h,fontSizeMedium:m,fontSizeLarge:u}=e;return Object.assign(Object.assign({},G),{fontSizeSmall:h,fontSizeMedium:m,fontSizeLarge:u,lineHeight:i,borderRadius:n,borderColor:t(a,r),borderColorModal:t(s,r),borderColorPopover:t(l,r),tdColor:a,tdColorModal:s,tdColorPopover:l,tdColorStriped:t(a,b),tdColorStripedModal:t(s,b),tdColorStripedPopover:t(l,b),thColor:t(a,c),thColorModal:t(s,c),thColorPopover:t(l,c),thTextColor:p,tdTextColor:g,thFontWeight:d})}const U={common:W,self:Q},X=o([C("table",`
 ...
 `),o("td",`
 background-color: var(--n-td-color-popover);
 `)]))]),Y=Object.assign(Object.assign({},z.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:String}),oo=q({name:"Table",props:Y,setup(e){const{mergedClsPrefixRef:r,inlineThemeDisabled:a,mergedRtlRef:s,mergedComponentPropsRef:l}=J(e),c=f(()=>{var d,i;return e.size||((i=(d=l?.value)===null||d===void 0?void 0:d.Table)===null||i===void 0?void 0:i.size)||"medium"}),b=z("Table","-table",X,U,e,r),p=N("Table",s,r),g=f(()=>{const d=c.value,{self:{borderColor:i,tdColor:h,tdColorModal:m,tdColorPopover:u,thColor:P,thColorModal:S,thColorPopover:M,thTextColor:R,tdTextColor:k,borderRadius:T,thFontWeight:B,lineHeight:y,borderColorModal:_,borderColorPopover:$,tdColorStriped:w,tdColorStripedModal:L,tdColorStripedPopover:O,[x("fontSize",d)]:j,[x("tdPadding",d)]:E,[x("thPadding",d)]:H},common:{cubicBezierEaseInOut:V}}=b.value;return{"--n-bezier":V,"--n-td-color":h,"--n-td-color-modal":m,"--n-td-color-popover":u,"--n-td-text-color":k,"--n-border-color":i,"--n-border-color-modal":_,"--n-border-color-popover":$,"--n-border-radius":T,"--n-font-size":j,"--n-th-color":P,"--n-th-color-modal":S,"--n-th-color-popover":M,"--n-th-font-weight":B,"--n-th-text-color":R,"--n-line-height":y,"--n-td-padding":E,"--n-th-padding":H,"--n-td-color-striped":w,"--n-td-color-striped-modal":L,"--n-td-color-striped-popover":O}}),n=a?A("table",f(()=>c.value[0]),g,e):void 0;return{rtlEnabled:p,mergedClsPrefix:r,cssVars:a?void 0:g,themeClass:n?.themeClass,onRender:n?.onRender}},render(){var e;const{mergedClsPrefix:r}=this;return(e=this.onRender)===null||e===void 0||e.call(this),D("table",{class:[`${r}-table`,this.themeClass,{[`${r}-table--rtl`]:this.rtlEnabled,[`${r}-table--bottom-bordered`]:this.bottomBordered,[`${r}-table--bordered`]:this.bordered,[`${r}-table--single-line`]:this.singleLine,[`${r}-table--single-column`]:this.singleColumn,[`${r}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}});export{oo as _};
