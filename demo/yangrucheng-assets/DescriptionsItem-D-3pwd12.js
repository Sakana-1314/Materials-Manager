import{m as H,a7 as C,p as h,n as e,ab as W,q as _,s as k,aI as G,aJ as K,d as E,aM as N,l,aN as q,t as J,v as V,x as Q,y as j,aK as A}from"./index-DwihmnM-.js";import{g as U}from"./get-slot-Bk_rJcZu.js";import{u as X}from"./use-compitable-B7BOEIuK.js";function D(t,c="default",p=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const n=i[c];if(typeof n=="function")return n()}return p}const Y={thPaddingBorderedSmall:"8px 12px",thPaddingBorderedMedium:"12px 16px",thPaddingBorderedLarge:"16px 24px",thPaddingSmall:"0",thPaddingMedium:"0",thPaddingLarge:"0",tdPaddingBorderedSmall:"8px 12px",tdPaddingBorderedMedium:"12px 16px",tdPaddingBorderedLarge:"16px 24px",tdPaddingSmall:"0 0 8px 0",tdPaddingMedium:"0 0 12px 0",tdPaddingLarge:"0 0 16px 0"};function Z(t){const{tableHeaderColor:c,textColor2:p,textColor1:i,cardColor:n,modalColor:b,popoverColor:m,dividerColor:a,borderRadius:s,fontWeightStrong:d,lineHeight:S,fontSizeSmall:r,fontSizeMedium:v,fontSizeLarge:u}=t;return Object.assign(Object.assign({},Y),{lineHeight:S,fontSizeSmall:r,fontSizeMedium:v,fontSizeLarge:u,titleTextColor:i,thColor:C(n,c),thColorModal:C(b,c),thColorPopover:C(m,c),thTextColor:i,thFontWeight:d,tdTextColor:p,tdColor:n,tdColorModal:b,tdColorPopover:m,borderColor:C(n,a),borderColorModal:C(b,a),borderColorPopover:C(m,a),borderRadius:s})}const ee={common:H,self:Z},oe=h([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),F="DESCRIPTION_ITEM_FLAG";function re(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[F]:!1}const te=Object.assign(Object.assign({},V.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:String,bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),de=E({name:"Descriptions",props:te,slots:Object,setup(t){const{mergedClsPrefixRef:c,inlineThemeDisabled:p,mergedComponentPropsRef:i}=J(t),n=j(()=>{var s,d;return t.size||((d=(s=i?.value)===null||s===void 0?void 0:s.Descriptions)===null||d===void 0?void 0:d.size)||"medium"}),b=V("Descriptions","-descriptions",oe,ee,t,c),m=j(()=>{const{bordered:s}=t,d=n.value,{common:{cubicBezierEaseInOut:S},self:{titleTextColor:r,thColor:v,thColorModal:u,thColorPopover:M,thTextColor:B,thFontWeight:I,tdTextColor:O,tdColor:o,tdColorModal:y,tdColorPopover:T,borderColor:g,borderColorModal:f,borderColorPopover:w,borderRadius:z,lineHeight:x,[A("fontSize",d)]:P,[A(s?"thPaddingBordered":"thPadding",d)]:$,[A(s?"tdPaddingBordered":"tdPadding",d)]:R}}=b.value;return{"--n-title-text-color":r,"--n-th-padding":$,"--n-td-padding":R,"--n-font-size":P,"--n-bezier":S,"--n-th-font-weight":I,"--n-line-height":x,"--n-th-text-color":B,"--n-td-text-color":O,"--n-th-color":v,"--n-th-color-modal":u,"--n-th-color-popover":M,"--n-td-color":o,"--n-td-color-modal":y,"--n-td-color-popover":T,"--n-border-radius":z,"--n-border-color":g,"--n-border-color-modal":f,"--n-border-color-popover":w}}),a=p?Q("descriptions",j(()=>{let s="";const{bordered:d}=t;return d&&(s+="a"),s+=n.value[0],s}),m,t):void 0;return{mergedClsPrefix:c,cssVars:p?void 0:m,themeClass:a?.themeClass,onRender:a?.onRender,compitableColumn:X(t,["columns","column"]),inlineThemeDisabled:p,mergedSize:n}},render(){const t=this.$slots.default,c=t?N(t()):[];c.length;const{contentClass:p,labelClass:i,compitableColumn:n,labelPlacement:b,labelAlign:m,mergedSize:a,bordered:s,title:d,cssVars:S,mergedClsPrefix:r,separator:v,onRender:u}=this;u?.();const M=c.filter(o=>re(o)),B={span:0,row:[],secondRow:[],rows:[]},O=M.reduce((o,y,T)=>{const g=y.props||{},f=M.length-1===T,w=["label"in g?g.label:D(y,"label")],z=[D(y)],x=g.span||1,P=o.span;o.span+=x;const $=g.labelStyle||g["label-style"]||this.labelStyle,R=g.contentStyle||g["content-style"]||this.contentStyle;if(b==="left")s?o.row.push(l("th",{class:[`${r}-descriptions-table-header`,i],colspan:1,style:$},w),l("td",{class:[`${r}-descriptions-table-content`,p],colspan:f?(n-P)*2+1:x*2-1,style:R},z)):o.row.push(l("td",{class:`${r}-descriptions-table-content`,colspan:f?(n-P)*2:x*2},l("span",{class:[`${r}-descriptions-table-content__label`,i],style:$},[...w,v&&l("span",{class:`${r}-descriptions-separator`},v)]),l("span",{class:[`${r}-descriptions-table-content__content`,p],style:R},z)));else{const L=f?(n-P)*2:x*2;o.row.push(l("th",{class:[`${r}-descriptions-table-header`,i],colspan:L,style:$},w)),o.secondRow.push(l("td",{class:[`${r}-descriptions-table-content`,p],colspan:L,style:R},z))}return(o.span>=n||f)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),b!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},B).rows.map(o=>l("tr",{class:`${r}-descriptions-table-row`},o));return l("div",{style:S,class:[`${r}-descriptions`,this.themeClass,`${r}-descriptions--${b}-label-placement`,`${r}-descriptions--${m}-label-align`,`${r}-descriptions--${a}-size`,s&&`${r}-descriptions--bordered`]},d||this.$slots.header?l("div",{class:`${r}-descriptions-header`},d||U(this,"header")):null,l("div",{class:`${r}-descriptions-table-wrapper`},l("table",{class:`${r}-descriptions-table`},l("tbody",null,b==="top"&&l("tr",{class:`${r}-descriptions-table-row`,style:{visibility:"collapse"}},q(n*2,l("td",null))),O))))}}),ne={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},ae=E({name:"DescriptionsItem",[F]:!0,props:ne,slots:Object,render(){return null}});export{ae as _,de as a};
