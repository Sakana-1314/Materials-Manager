...
features:
  ...
  - title: 申购与补库
    details: 申购计划可暂缺编码，低库存按近 6 个月消耗给出建议数量，请购记录与到货入库衔接。
  - title: 采购跟踪
...
服务对象：华星镍业检修维护部电气自动化车间。当前覆盖二级库物资与库存流水、申购计划、
请购与到货、采购跟踪、精简库存、图片附件、表格导入导出、链接分享、用户与权限、AI 搜索与 MCP、
备忘录等功能。**不涉及物资价格和成本核算**。
...
- [API 错误与状态码约定](/api-error-conventions) / [错误码总表](/api-error-codes)：错误响应结构与全部错误码。
